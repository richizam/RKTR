...
```
index.html          оболочка: вкладки линий, popup прослеживаемости,
                    wheel drawer, панель процессных параметров
styles.css          оформление, CAD-стиль, статусы, подсветка активной станции
script.js           данные, движок анимации (Web Animations API), mock-PLC,
                    обработка кликов, панели
process-params.js   262 процессных параметра по 14 единицам оборудования
machining-line.svg  векторная CAD-подобная схема линии механообработки
testing-line.svg    векторная CAD-подобная схема линии контроля и испытаний
images/             фотографии оборудования, встроенные в схемы
```

## Технологии

- HTML, CSS, JavaScript (без фреймворков и без шага сборки)
- SVG для CAD-подобных схем линий
- Web Animations API для анимации манипуляторов и движения детали
